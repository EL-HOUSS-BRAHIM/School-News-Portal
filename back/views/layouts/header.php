...
<body>
        ...
        <div class="container">
            <div class="owl-carousel owl-carousel-2 carousel-item-3 position-relative">
                <?php if (!empty($trendingArticles)): ?>
                    <?php foreach ($trendingArticles as $article): ?>
                        <div class="d-flex">
                            <img src="<?php echo htmlspecialchars($article['image'] ?? $app['constants']['ASSETS_URL'] . '/img/default.jpg'); ?>" style="width: 80px; height: 80px; object-fit: cover;">
                            <div class="d-flex align-items-center bg-light px-3" style="height: 80px;">
                                <a class="text-secondary font-weight-semi-bold" href="/article/<?php echo urlencode($article['title']); ?>"><?php echo htmlspecialchars($article['title']); ?></a>
                            </div>
                        </div>
                    <?php endforeach; ?>
                <?php else: ?>
                        ...
                        <?php if (!empty($trendingArticles)): ?>
                            <?php foreach ($trendingArticles as $article): ?>
                                <div class="position-relative overflow-hidden" style="height: 435px;">
                                    <img class="img-fluid h-100" src="<?php echo htmlspecialchars($article['image'] ?? $app['constants']['ASSETS_URL'] . '/img/default.jpg'); ?>" style="object-fit: cover;">
                                    <div class="overlay">
                                        <div class="mb-1">
                                        ...
                                        <a class="h2 m-0 text-white font-weight-bold" href="/article/<?php echo urlencode($article['title']); ?>"><?php echo htmlspecialchars($article['title']); ?></a>
                                    </div>
                                </div>
                            <?php endforeach; ?>
                        <?php else: ?>
    ...
    <div class="d-flex align-items-center justify-content-between bg-light py-2 px-4 mb-3">
        ...
        <a class="text-secondary font-weight-medium text-decoration-none" href="/categories">View All</a>
    </div>
    <?php if (!empty($categories)): ?>
        <?php foreach ($categories as $category): ?>
            <div class="position-relative overflow-hidden mb-3" style="height: 80px;">
                <?php if ($category['image']): ?>
                    <img class="img-fluid w-100 h-100" src="<?php echo htmlspecialchars($category['image']); ?>" style="object-fit: cover;">
                <?php else: ?>
                ...
                <?php endif; ?>
                <a href="/category/<?php echo urlencode($category['slug']); ?>" class="overlay align-items-center justify-content-center h4 m-0 text-white text-decoration-none">
